...
![CI Build](https://github.com/n1tr0oo/REPOSITORY/actions/workflows/ci-build.yaml/badge.svg)

Flask REST microservice for creating, listing, reading, updating, and deleting customer accounts. Replace `REPOSITORY` in the badge after creating the public repository.
...
tkn pipeline start accounts-cd --showlog \
  -p repo-url=https://github.com/n1tr0oo/REPOSITORY.git -p branch=main \
...
git remote add origin https://github.com/n1tr0oo/REPOSITORY.git
